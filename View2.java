...
public class View2 
{
    ...
    String a,b;
    View2() throws SQLException 
    {
        f = new JFrame("Attendance View");
        f.setLayout(null);
        ...
        l1 = new JLabel("Attendance View");
        l1.setBounds(280,0,300,50); 
        ...
        { 
            ...
            public void focusLost(FocusEvent e)
            {
                if (t1.getText().isEmpty())
                {
                    ...
                    {
                        Logger.getLogger(View2.class.getName())
        ...
        b1.addActionListener(new ActionListener()
        {
            ...
            {
                ConnectionClass obj = new ConnectionClass(); 
                String sql = "Select *from attend where eid = ?"; 
        ...
        { 
            public void actionPerformed(ActionEvent e)
            {
                ...
                else 
                {
                    ...
                    ResultSet rs = null;
                    String query = "Select *from attend where id = ?";
                    try
                    {
                        ConnectionClass obj = new ConnectionClass();
                        ...
                        while (rs.next())
                        {
                            ...
                            attend.t1.setText(eid);
                            attend.t1.setEnabled(false);
                            attend.t2.setText(ename);
                            //attend.cb1.setSelectedItem(dept);
                            attend.cb1.setEnabled(false);
                            if (attendance.equals("Present"))
                                attend.r1.setSelected(true);
                            else
                                attend.r2.setSelected(true);
                            attend.b2.setEnabled(false);
                            attend.b4.setEnabled(true);
                        }
                    }
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                else 
                {
                    ...
                    if (choice == JOptionPane.YES_OPTION)
                    {
                        ...
                        try
                        {
                            pstmt = obj.con.prepareStatement("Delete from attend where id = ?");
                            pstmt.setString(1, b);
